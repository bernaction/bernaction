...
**Engenharia de Computação** - UNIVALI - Universidade do Vale do Itajaí
...
- **Status**: Aprovado para publicação no IEEE Xplore
...
- **Plataformas**: Xilinx FPGAs, Intel/Altera FPGAs
...
### 📐 Simulação e Cálculo
![NI Multisim](https://img.shields.io/badge/NI_Multisim-1A73E8?style=for-the-badge&logo=labview&logoColor=white)
![MATLAB](https://img.shields.io/badge/MATLAB-0076A8?style=for-the-badge&logo=mathworks&logoColor=white)

- **Simulação de Circuitos**: Multisim (NI)
- **Cálculo e Modelagem**: MATLAB, Simulink
- **Aplicações**: análise de circuitos, modelagem matemática, prototipagem
...
- **Uso**: Assistente de desenvolvimento e testes

### 🎥 Criação de Conteúdo
![YouTube](https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)
![VEGAS Pro](https://img.shields.io/badge/VEGAS_Pro-1A1A1A?style=for-the-badge&logo=vega&logoColor=white)
...
- **Plataforma**: [**YouTube Berna Cripto**](https://youtube.com/bernacripto)
- **Conteúdo**: Mineração caseira de criptomoedas
- **Ferramentas**: MAGIX VEGAS Pro, Adobe Photoshop, OBS Studio
- **Foco**: Educação e divulgação técnica

---

## 💼 Áreas de Atuação

- ⚡ **FPGA e Hardware**: Design digital, VHDL, High-Level Synthesis (HLS)
- ₿ **Criptomoedas**: Mineração, implementação de algoritmos criptográficos em hardware
- 🎥 **Criação de Conteúdo**: Canal no YouTube sobre mineração caseira de criptomoedas
- 🔐 **Criptografia**: Implementação de SHA-256 e outros algoritmos de hash
- 💻 **Desenvolvimento de Software**: Uso de IA para auxiliar no desenvolvimento e testes
...
- 📚 Pesquisador com artigo aprovado para publicação no IEEE
- 🎬 Criador do canal [**Berna Cripto**](https://youtube.com/bernacripto) no YouTube
- ⛏️ Especialista em mineração caseira de criptomoedas
- 🔧 Experiência com desenvolvimento em FPGA usando Vivado e Vivado HLS
- 🤖 Utilizo ferramentas de IA para otimizar desenvolvimento e realizar testes
- 🤝 Aberto a colaborações em projetos de hardware e criptomoedas
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/bernaction)
[![YouTube](https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtube.com/bernacripto)

---

<div align="center">
  <i>⚡ "O futuro da computação está na interseção entre hardware e software" ⚡</i>
</div>
